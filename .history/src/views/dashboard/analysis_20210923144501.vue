    ...
    <div class="df a-center j-space-between">
      ...
      <div>
        <a-select
          ...
          @change="handleChange"
        >
          <a-select-option v-for="item in items" :value="item.value">{{ item.name }}</a-select-option>
          <a-select-option value="1">30秒</a-select-option>
          <a-select-option value="2">1分钟</a-select-option>
          <a-select-option value="3">10分钟</a-select-option>
